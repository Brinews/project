...
class RatingListPanel extends JPanel
{
	private static final Timer time = new Timer("RATING");

	Vector<Vector<Object>> colData = new Vector<Vector<Object>>();
	Vector<String> colNames = new Vector<String>();
	private JTable rTable;

	public RatingListPanel()
	{
		refreshData();
	...
	{
		String[] names = {"ID", "Mem Name", "Rating"};

		for (int i = 0; i < names.length; i++)
			colNames.add(names[i]);

		String sql = MySqlHash.getHashSql("RATING LIST");
